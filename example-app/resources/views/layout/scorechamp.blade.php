...
<head>
    ...
    <!-- Retirer l'attribut integrity pour corriger l'erreur de chargement -->
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: data.map(score => {
                            if (score === 0) {
                                return 0.1; // Ajustement spécifique pour score égal à zéro
                            } else {
                                return score; // Garder les autres scores inchangés
                            }
                        }),
